...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-2 text-gray-800">Ubah Data Objek Bangunan</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form ubah data objek bangunan</h6>
        </div>
        <div class="p-3">
            <form action="{{ route('building-object.update', ['building_object' => $buildingObject]) }}" method="post">
                @csrf
                @method('put')
                <div class="mb-3">
                    <label for="name">Nama</label>
                    <input class="form-control form-control-solid" id="name" type="text" placeholder="toko" name="name"
                        value="{{ old('name', $buildingObject->name) }}">
                </div>
                <div class="mb-3">
                    ...
                    <textarea class="form-control form-control-solid" id="name" type="text" placeholder="deskripsi"
                        name="description">{{ old('description', $buildingObject->description) }}</textarea>
                </div>
